...
const MONGODB_URI = process.env.MONGODB_URI || "mongodb+srv://aman:21632AMAN@cluster0.jrfj4bn.mongodb.net/mernstck?retryWrites=true&w=majority";
const API_KEY = process.env.OPENWEATHERMAP_API_KEY || "b00ad796853a3f16c4b4f1884621bf37";
...
app.get('/api/alerts', async (req, res) => {
  // Placeholder for alerts endpoint
});
